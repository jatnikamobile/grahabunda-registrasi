...
class MasterPasienController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if (!$new_pasien) {
            ...
            $new_pasien->NamaAyah = $request->WargaNegara;
            $new_pasien->NamaIbu = $request->NoIden;
            $new_pasien->AskesNo = $request->NoPeserta;
            $new_pasien->Address = $request->Agama;
            $new_pasien->City = $request->Pendidikan;
            ...
            $new_pasien->NamaAyah = $request->WargaNegara ?: $new_pasien->NamaAyah;
            $new_pasien->NamaIbu = $request->NoIden ?: $new_pasien->NamaIbu;
            $new_pasien->AskesNo = $request->NoPeserta ?: $new_pasien->AskesNo;
            $new_pasien->Address = $request->Agama ?: $new_pasien->Address;
            $new_pasien->City = $request->Pendidikan ?: $new_pasien->City;
