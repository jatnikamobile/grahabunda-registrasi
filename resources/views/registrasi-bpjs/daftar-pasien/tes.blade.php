...
<section>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <a href="{{route('reg-bpjs-daftar')}}" class="btn btn-warning btn-sm"> Kembali</a>
    ...
    <form action="{{ route('reg-bpjs-daftar.form-post') }}" method="post" class="row" id="form-psn-bpjs">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-9">
                        ...
                        <select name="DokterPengirim" id="DokterPengirim" style="width:100%;" class="form-control input-sm select2" readonly="readonly">
                            <option value="{{ isset($edit->KdDPJP) ? $edit->KdDPJP : '' }}">{{ isset($edit->KdDPJP) ? @$edit->KdDPJP : '-= Dokter Pengirim =-' }}</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        ...
                        <select name="KdTuju" id="pengobatan" style="width:100%;" class="form-control input-sm select2 col-xs-6 col-sm-6">
                            <option value="{{ isset($edit->KdTuju) ? $edit->KdTuju : '' }}">{{ isset($edit->NMTuju) ? @$edit->NMTuju : '-= Tujuan Pelayanan =-' }}</option>
                        </select>
                    </div>
                </div>
                <!-- Nama Poli / SMF -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        ...
                        <select type="text" name="KdCbayar" id="cara_bayar" style="width:100%;" class="form-control select2 input-sm col-xs-6 col-sm-6">
                            <option value="20" selected="selected">BPJS</option>
                        </select>
                    </div>
                </div>
                <!-- Peserta -->
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <textarea class="form-control input-sm col-xs-10 col-sm-5" name="catatan" id="catatan"></textarea>
                    </div>
                </div>
                <!-- No SEP -->
                <div class="form-group">
        ...
        <input type="text" name="regold" id="regold" value="{{ @$edit->IdRegOld }}">
    ...
    $("#submit").on("click",function(e){
        ...
        if ($('#pengobatan').val() == '') {
            ...
            if ($('#Medrec').val() != '') {
                ...
                //     $.ajax({
                //         url:"{{ route('api.update_sep') }}",
                //         type:"put",
                //         dataType:"json",
                //         data:{
                //             NoSep: $('#NoSep').val(),
                //             klsRawat: $('#pengobatan').val() == 2 ? 3 : $('#jatah_kelas').val(),
                //             noMR: $('#Medrec').val(),
                ...
                //                 alert('Update sep: '+response.metaData.message);
                //             }else{
                //                 alert(response.metaData.message);
                //                 $('#NoSep').val(response.data);
                //             }
                //         }
                //     });
                // }
