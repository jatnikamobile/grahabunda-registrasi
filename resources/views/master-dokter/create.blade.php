...
@section('title','Create Dokter | Modul Registrasi')
@section('menu_master_dokter','active')
@section('header','Create Dokter')
@section('content')
<section>
	<div>
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        ...
                        <input type="text" name="kode_dokter" id="kode_dokter" class="form-control input-sm col-xs-6 col-sm-6"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="nama_dokter" id="nama_dokter" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="sip_dokter" id="sip_dokter" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="kode_dpjp" id="kode_dpjp" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <textarea type="text" name="alamat" id="alamat" class="form-control input-sm col-xs-6 col-sm-6"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="kota" id="kota" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="kode_pos" id="kode_pos" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="telepon" id="telepon" class="form-control input-sm col-xs-6 col-sm-6">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6">
						...
						<select name="poli" id="poli" style="width:100%;" class="form-control input-sm col-xs-6 col-sm-6">
                            ...
                            @if (count($poli) > 0)
                                @foreach ($poli as $pl)
                                    <option value="{{ $pl->KDPoli }}">{{ $pl->NMPoli }}</option>
                                @endforeach
                            @endif
						</select>
                    </div>
