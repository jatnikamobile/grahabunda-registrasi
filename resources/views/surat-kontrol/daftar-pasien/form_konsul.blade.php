        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                        <input type="text" name="NoRujuk" class="form-control input-sm" id="NoRujuk" value=""/>
                        <!-- Jam Registrasi -->
...
<script>
    ...
    $('#search_noRujukan').submit(function(ev) {
        ...
        //if (getdata == '1') {
           $.ajax({
            url:"{{ route('reg-bpjs-daftar.find-konsul') }}",
            type:"get",
            dataType:"json",
            data:{
                nosurat: $('#NoRujuk').val(),
            ...
            success:function(response){
                ...
                var $diagnosa = $("<option selected></option>").val(response.Diagnosa).text(response.DIAGNOSA);
                $('#Diagnosa').append($diagnosa).trigger('change');
