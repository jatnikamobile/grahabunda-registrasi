...
<script>
    ...
    $('#search_nosurat').submit(function(ev) {
        ...
        loading.modal('show');
        $.ajax({
            url:"{{ route('reg-bpjs-daftar.find-rujukrad') }}",
            type:"get",
            dataType:"json",
            data:{
                                        ...
                                        if(resp.status){
                                            ...
                                            $.ajax({
                                                ...
                                                success:function(response)
                                                {
                                                    ...
                                                    update_radiologi('<?=$nosurat?>', response.data.Regno);
                                            ...
                                            update_radiologi('<?=$nosurat?>', resp.data.Regno);
                                            loading.modal('hide');
    ...
    function update_radiologi(notrans, regno) {
        $.ajax({
            url:"{{ route('reg-bpjs-daftar.up-radiologi') }}",
            type:"get",
            dataType:"JSON",
            data:{
