...
<table class="table-top" >
    <tbody>
        <tr>
            <td style="width: 10%; text-align: center; border-right: 1px solid black;"><img src="/template/images/thumb/logo-majalaya.png" class="logo"></td>
            <td><center>RSUD Majalaya <br>INSTALASI RAWAT JALAN</center></td>
